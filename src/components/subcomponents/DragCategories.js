    ...
    return (
        <>
            <div className={` ${isOver ? 'bg-pink-100' : ''}`} ref={drop}>
                <div className={`flex gap-2 items-center ${isDragging ? 'bg-slate-100' : ''}`} ref={drag}>
                    <div className='flex  gap-2'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="mt-1 mr-1 bi bi-filter-circle shrink-0" viewBox="0 0 16 16">
